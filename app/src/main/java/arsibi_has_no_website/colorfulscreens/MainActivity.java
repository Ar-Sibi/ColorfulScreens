...
public class MainActivity extends AppCompatActivity {
    public static final int RED_CHANGED=1;
    public static final int GREEN_CHANGED=1;
    public static final int BLUE_CHANGED=1;
    public static final int BACKGROUND_CHANGED=1;
    int red=0;
    int green=0;
    int blue=0;
    ...
    public void redder(View v) {
        red=(red+5)>256?0:red+5;
        setBackground();
        handleChanges(1);
    }
    public void greener(View v) {
        green=(green+5)>256?0:green+5;
        setBackground();
        handleChanges(2);
    }
    public void bluer(View v){
        blue=(blue+5)>256?0:blue+5;
        setBackground();
        handleChanges(3);
    }
